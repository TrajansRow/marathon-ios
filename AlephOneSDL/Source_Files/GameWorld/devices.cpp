...
bool line_is_within_range(short monster_index, short line_index, world_distance range); //Changed to non-static for iOS port
...
bool line_is_within_range( //Changed to non-static for iOS port
	short monster_index,
	short line_index,
	world_distance range)
{
